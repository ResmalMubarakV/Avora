...
const WhyChooseAvora = () => {
    return (
        <section className="relative overflow-hidden mx-auto max-w-7xl px-5 py-24 md:px-8 md:py-32">
            ...
            <div className="relative z-10 mx-auto max-w-3xl text-center">
                ...
                <h2 className="mt-8 text-3xl font-extrabold leading-tight tracking-tight text-slate-900 sm:text-4xl lg:text-5xl">
                    More Than A Gallery.
                    <br />
            ...
            <div className="relative z-10 mx-auto mt-16 grid max-w-5xl grid-cols-1 gap-6 sm:mt-24 md:grid-cols-2 lg:gap-8">
                {features.map((feature, idx) => {
                    const Icon = feature.icon;
                    return (
                        <div
                            key={feature.title}
                            className="group relative flex flex-col items-start gap-4 rounded-[2rem] bg-white p-8 sm:p-10 transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_20px_60px_-15px_rgba(30,58,138,0.15)] border border-slate-100 hover:border-blue-100 overflow-hidden"
                        >
                            {/* Hover Glow Effect */}
