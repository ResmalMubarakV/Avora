...
// ==========================================
/**
 * Renders the main hero section of the landing page. Features value proposition badge, 
 * bold typography, primary/secondary action links, and an animated showcase hero illustration.
 */
const LandingHero = () => {
    return (
        <section className="mx-auto flex max-w-7xl flex-col-reverse items-center gap-12 px-5 py-12 md:flex-row md:items-center md:justify-between md:gap-10 md:px-8 md:py-16 lg:min-h-[calc(100vh-96px)] lg:py-0">
            ...
            <div className="w-full text-center md:max-w-md md:text-left lg:max-w-xl">
                ...
                {/* Heading */}
                <h1 className="mt-6 text-4xl font-bold leading-tight tracking-tight text-slate-900 sm:text-5xl lg:mt-8 lg:text-6xl lg:leading-[1.08]">
                    Every Journey
                    <br />
                    Deserves To Be
                    <br />
                ...
                <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:justify-center md:justify-start lg:mt-10">
                    <Link
                        to="/register"
                        className="rounded-full bg-slate-900 px-7 py-3.5 text-center font-semibold text-white shadow-md transition-all duration-300 hover:-translate-y-0.5 hover:bg-slate-800 hover:shadow-lg"
                    >
                        Start Your Journey
                    </Link>
                    ...
                    <Link
                        to="/login"
                        className="rounded-full border border-slate-300 px-7 py-3.5 text-center font-semibold text-slate-900 transition-all duration-300 hover:-translate-y-0.5 hover:bg-slate-100"
                    >
                        Login
                    </Link>
                </div>
            ...
            <div className="flex w-full justify-center md:flex-1 md:justify-end">
                <img
                    src={heroLanding}
                    alt="Avora Hero Illustration"
                    draggable="false"
                    className="w-full max-w-[280px] animate-float object-contain transition-transform duration-500 hover:-translate-y-2 hover:scale-[1.02] sm:max-w-sm md:max-w-md lg:max-w-2xl drop-shadow-2xl"
                />
            </div>
        </section>
    );
