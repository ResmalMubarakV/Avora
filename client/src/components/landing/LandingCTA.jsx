...
const LandingCTA = () => {
    return (
        <section className="mx-auto max-w-7xl px-5 py-16 md:px-8 md:py-24">
            <div className="relative overflow-hidden rounded-[2.5rem] bg-[#0A1128] px-6 py-20 text-center sm:px-10 sm:py-24 lg:rounded-[3rem] lg:px-12 lg:py-32 shadow-[0_30px_80px_rgba(15,23,42,0.4)] border border-blue-900/30">
                ...
                <div className="relative z-10 mx-auto max-w-3xl">
                    ...
                    <div className="mt-12 flex justify-center">
                        <Link
                            to="/register"
                            className="inline-flex items-center justify-center rounded-full bg-white px-8 py-4 text-base font-bold text-[#0F172A] shadow-[0_0_40px_rgba(255,255,255,0.2)] transition-all duration-300 hover:-translate-y-1 hover:bg-blue-50 hover:shadow-[0_0_60px_rgba(255,255,255,0.3)] active:scale-95"
                        >
