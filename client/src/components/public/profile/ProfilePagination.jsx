...
const ProfilePagination = ({
    ...
    return (
        ...
        >
            <div className="inline-flex items-center gap-1.5 rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 px-3 py-2 shadow-sm transition-colors">
                <button
                    type="button"
                    disabled={currentPage === 1}
                    onClick={() => handlePageChange(currentPage - 1)}
                    className="inline-flex items-center gap-1 rounded-xl px-3 py-1.5 text-xs font-semibold text-slate-700 dark:text-slate-200 transition hover:bg-slate-100 dark:hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-30 cursor-pointer"
                >
                    <ChevronLeft size={14} />
                        ...
                        return (
                            <button
                                ...
                                className={`flex h-8 w-8 items-center justify-center rounded-xl text-xs font-bold transition cursor-pointer ${
                                    isCurrent
                                        ? "bg-[#1E3A8A] dark:bg-gradient-to-r dark:from-indigo-600 dark:to-blue-600 text-white shadow-sm"
