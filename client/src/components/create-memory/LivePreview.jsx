...
// ==========================================
/**
 * Renders a real-time card preview of a travel memory as the user updates form fields.
 * Scales down translation coordinates proportionally for a seamless 1:1 match.
 */
const LivePreview = ({ formData }) => {
  // --- Generate Cover Preview URL from File or Existing Cover URL ---
  ...
  const previewRatio = 0.45; // Scales down translation offset to fit smaller card preview frame

  // --- Cleanup Cover Object URL on Unmount or Change ---
  useEffect(() => {
    return () => {
