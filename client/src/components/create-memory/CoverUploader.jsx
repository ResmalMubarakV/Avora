...
// ==========================================
/**
 * File upload, preview, and interactive adjustment component for cover images.
      ...
      <div className="mb-5 sm:mb-6 flex items-center justify-between">
        <div>
          <h2 className="text-base sm:text-lg lg:text-xl font-bold text-slate-900">
            {rawPreview ? (isAdjusting ? "Adjust Cover Image" : "Cover Ready") : "Cover Image"}
          </h2>
          <p className="mt-0.5 text-xs sm:text-sm text-slate-500">
            {rawPreview
              ? isAdjusting
                ? "Drag to reposition and use controls to zoom."
                : "Looking good! Fine-tune or replace it anytime."
