      ...
      <div className="w-full max-w-md rounded-3xl bg-white p-8 shadow-2xl">
        ...
        <div className="mt-8 flex justify-end gap-3">
          <button
            ...
            onClick={onClose}
            disabled={loading}
            className="rounded-xl border border-slate-200 px-5 py-3 font-medium text-slate-700 transition hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-50"
          >
            Cancel
          </button>
