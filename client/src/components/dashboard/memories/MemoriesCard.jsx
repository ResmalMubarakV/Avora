...
const MemoriesCard = ({
  ...
  return (
    <div
      ...
      className="group relative cursor-pointer overflow-hidden rounded-2xl sm:rounded-3xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900/95 shadow-[0_2px_12px_rgba(30,58,138,0.04)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.4)] transition-all duration-300 hover:-translate-y-1 hover:border-slate-300 dark:hover:border-indigo-500/80 hover:shadow-[0_8px_25px_rgba(30,58,138,0.08)] dark:hover:shadow-[0_0_25px_rgba(99,102,241,0.25)] flex flex-col justify-between select-none"
    >
      <div>
