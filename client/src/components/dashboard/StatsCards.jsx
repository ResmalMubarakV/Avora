  ...
  const stats = [
    {
      ...
      icon: Images,
      cardGradient: "from-[#F8FAFC] via-[#F1F5F9] to-blue-50/50 dark:from-slate-900 dark:via-slate-900 dark:to-slate-900/95",
      iconBg: "bg-white dark:bg-slate-800/90",
      iconBorder: "border-slate-300/80 dark:border-slate-700/60",
      iconColor: "text-slate-800 dark:text-slate-200",
      accentBorder: "hover:border-slate-400 dark:hover:border-slate-600/80",
    ...
    },
    {
      ...
      icon: Globe2,
      cardGradient: "from-sky-50/80 via-blue-50/60 to-cyan-50/70 dark:from-slate-900 dark:via-slate-900 dark:to-slate-900/95",
      iconBg: "bg-white dark:bg-sky-950/60",
      iconBorder: "border-sky-200 dark:border-sky-800/50",
      iconColor: "text-sky-600 dark:text-sky-400",
      accentBorder: "hover:border-sky-400 dark:hover:border-sky-500/50",
      dotColor: "bg-sky-500 dark:bg-sky-400",
      glowColor: "group-hover:bg-sky-200/50 dark:group-hover:bg-sky-900/30",
    ...
    },
    {
      ...
      icon: Lock,
      cardGradient: "from-indigo-50/80 via-blue-50/70 to-slate-50/80 dark:from-slate-900 dark:via-slate-900 dark:to-slate-900/95",
      iconBg: "bg-white dark:bg-indigo-950/60",
      iconBorder: "border-indigo-200 dark:border-indigo-800/50",
      iconColor: "text-[#1E3A8A] dark:text-indigo-400",
      accentBorder: "hover:border-indigo-400 dark:hover:border-indigo-500/50",
      dotColor: "bg-[#1E3A8A] dark:bg-indigo-400",
      glowColor: "group-hover:bg-indigo-200/50 dark:group-hover:bg-indigo-900/30",
    ...
    },
    {
      ...
      icon: Heart,
      cardGradient: "from-blue-50/80 via-indigo-50/60 to-sky-50/70 dark:from-slate-900 dark:via-slate-900 dark:to-slate-900/95",
      iconBg: "bg-white dark:bg-blue-950/60",
      iconBorder: "border-blue-200 dark:border-blue-800/50",
      iconColor: "text-[#3559D4] dark:text-blue-400",
      accentBorder: "hover:border-blue-400 dark:hover:border-blue-500/50",
      dotColor: "bg-[#3559D4] dark:bg-blue-400",
      glowColor: "group-hover:bg-blue-200/50 dark:group-hover:bg-blue-900/30",
