          ...
          return (
            ...
            >
              ...
              <div className="relative z-10 w-full">
                ...
                <p className="mt-2.5 hidden text-[11px] xl:block font-medium text-slate-500/80 truncate border-t border-slate-100 pt-2.5 transition-colors group-hover:border-blue-100">
                  {stat.description}
                </p>
              </div>
            </button>
