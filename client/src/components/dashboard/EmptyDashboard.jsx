  ...
  return (
    <section className="min-h-[calc(100vh-170px)] flex items-center">
      ...
      >
        ...
        <div className="absolute -bottom-48 -left-40 w-[28rem] h-[28rem] rounded-full bg-blue-300/10 blur-3xl" />
        ...
        >
          ...
          <div className="text-center lg:text-left">
            ...
            <p
              ...
              "
            >
              Every unforgettable journey deserves a place to
              live. Capture your adventures with photos,
              videos, locations and stories, then revisit
            ...
            <button
              onClick={() =>
                navigate("/dashboard/create-memory")
              }
              className="
                mt-10
                inline-flex
