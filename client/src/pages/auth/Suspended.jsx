 ...
 * Provides details regarding the suspension, a direct mail link to support, 
 * and an option to log out of the current session.
 */
const Suspended = () => {
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-6 py-10">
      <div className="w-full max-w-md rounded-3xl border border-slate-200 bg-white px-8 py-10 shadow-sm">
        ...
        <div className="mt-6 space-y-5 text-center">
          ...
          <p className="text-slate-600 leading-7">
            If you believe this action was taken by mistake, please contact the Avora
            support team. We'll review your account and assist you as soon as possible.
          </p>
        </div>
        ...
        <a
          ...
          className="mt-10 flex w-full items-center justify-center gap-2 rounded-2xl bg-[#1E3A8A] px-6 py-3.5 font-semibold text-white transition-all duration-300 hover:bg-[#16213E] hover:scale-[1.01] active:scale-[0.98]"
        >
          <Mail size={18} />
