...
// ==========================================
/**
 * Allows users to set a new password using the reset token provided via URL parameters.
 * Handles validation, password strength indicators, API submission, and toast messaging.
 */
const ResetPassword = () => {
