...
import { ShieldCheck, Loader2, CheckCircle2, Eye, EyeOff, ShieldAlert, Check, X, KeyRound } from "lucide-react";
      ...
      <div className="w-full max-w-md space-y-6">
        <div className="rounded-[28px] border border-slate-200 bg-white p-8 shadow-sm">
          <div className="text-center space-y-2 mb-8">
            ...
            <h1 className="text-2xl font-black tracking-tight text-slate-900">Create New Password</h1>
          ...
          {success ? (
            <div className="space-y-6 text-center animate-in fade-in">
              <div className="flex flex-col items-center gap-3 rounded-2xl border border-emerald-200 bg-emerald-50 p-6 text-emerald-800">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2 rounded-2xl bg-[#1E3A8A] py-4 text-xs sm:text-sm font-extrabold text-white shadow-lg shadow-blue-900/20 transition hover:bg-[#3559D4] active:scale-95 cursor-pointer disabled:opacity-50"
              >
                {loading ? (
                  <>
