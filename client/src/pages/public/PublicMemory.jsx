    ...
    <main className="min-h-screen bg-[#F8FBFF]">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute inset-x-0 top-0 h-[360px] bg-gradient-to-b from-sky-100 via-blue-50 to-transparent" />
          <div className="absolute -left-32 top-0 h-72 w-72 rounded-full bg-sky-300/20 blur-[140px]" />
          <div className="absolute right-0 top-0 h-80 w-80 rounded-full bg-cyan-200/30 blur-[170px]" />
        </div>
      ...
      <section className="relative mx-auto max-w-[1500px] px-5 sm:px-8 lg:px-10 xl:px-14 pb-24">
        ...
        <div className="absolute inset-0 -z-10 flex items-center justify-center pointer-events-none">
          <div className="w-[800px] h-72 bg-gradient-to-r from-sky-200/30 via-blue-200/20 to-indigo-200/30 blur-[120px] rounded-full" />
        </div>

        <div className="relative overflow-hidden rounded-[36px] border border-slate-200/80 bg-gradient-to-br from-white via-white to-sky-50/40 shadow-2xl shadow-sky-950/[0.04] backdrop-blur-xl">
          <div className="px-6 py-8 sm:px-10 sm:py-10 lg:px-14 lg:py-14">
            {/* Heading */}
            <div className="flex items-center gap-4">
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-sky-500 to-blue-600 text-white shadow-lg shadow-blue-500/20">
                <Compass size={24} />
              </div>
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.30em] text-sky-600">
                  Travel Journal
                </p>
            ...
            {/* Story Content */}
            <div className="w-full text-[17px] leading-9 text-slate-600 whitespace-pre-line lg:text-[18px] lg:leading-10">
              {memory.description}
            </div>
          </div>
        </div>
